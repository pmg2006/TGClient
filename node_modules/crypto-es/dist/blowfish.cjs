...
*/
var BlowfishAlgo = class extends require_cipher_core.BlockCipher {
...
*/
const Blowfish = require_cipher_core.BlockCipher._createHelper(BlowfishAlgo);

//#endregion
exports.Blowfish = Blowfish;
exports.BlowfishAlgo = BlowfishAlgo;
