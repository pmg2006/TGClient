...
module.exports = function(projectName) {
  return {
    helloYeti: [
      'Thanks for using  Creator for %s!',
      '-------------------------------------------',
    ...
    gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the Creator for Apps template.\nMake sure your computer's Git is configured properly and then try again.",
    ...
    installSuccessFinal: "\nNow run " + "Creator watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "Creator watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
